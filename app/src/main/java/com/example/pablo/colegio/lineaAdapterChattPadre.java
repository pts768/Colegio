 ...
 */
public class lineaAdapterChattPadre extends BaseAdapter {
    ...
    public lineaAdapterChattPadre(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.linea_padre_chatt, null);
        }
        TextView txttitulopadre = (TextView) convertView.findViewById(R.id.txttitulopadre);
        Mensaje t = (Mensaje) getItem(position);
        txttitulopadre.setText(t.getTitulo());
